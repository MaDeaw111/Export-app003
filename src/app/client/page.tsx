                                ...
                                <div className="space-y-2 bg-slate-900/30 p-4 rounded-xl border border-slate-900">
                                  ...
                                  <div className="grid grid-cols-2 gap-3 text-xs">
                                    <div>
                                      ...
                                      <span className="text-white font-medium">{ship.forwarder_id || "Awaiting Booking"}</span>
                                    </div>
                                    <div>
                                      <span className="text-slate-500 block">Logistics Asset</span>
                                      <span className="text-white font-medium">{ship.truck_id || "Not assigned"}</span>
                                    </div>
                                    <div>
                                      <span className="text-slate-500 block">Estimated ETD</span>
                                      <span className="text-white font-medium">{ship.etd_date || "Scheduling"}</span>
                                    </div>
                                    <div>
                                      <span className="text-slate-500 block">Estimated ETA</span>
                                      <span className="text-white font-medium">{ship.eta_date || "Scheduling"}</span>
                                    </div>
                                  </div>
                                </div>
